---
description: "Generate all customer-facing deliverables: architecture diagram, cost breakdown, deployment guide, feature summary, security posture"
---

Generate all customer-facing deliverables for this project:

1. **Architecture Diagram** — Use Draw.io or Excalidraw MCP to create a professional, labeled system architecture diagram showing all components, Azure services, and data flows
