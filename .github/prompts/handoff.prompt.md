...
5. **MCAPS Considerations** — What's restricted, workarounds, private endpoints
6. **Architecture Decision Records** — Every significant decision and why (pull from Obsidian)
...
12. **Known Issues** — Current bugs, workarounds (pull from Obsidian)
