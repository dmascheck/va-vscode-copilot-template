...
4. Update the Obsidian project note via MCPVault:
...
5. Use @Architect to validate the architecture, check MCAPS compliance, produce an architecture diagram (Draw.io or Excalidraw), and generate an Azure cost estimate.
